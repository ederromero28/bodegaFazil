                    ...
                    <div className="row border-top py-3">
                        <div className="d-lg-flex justify-content-lg-between align-items-lg-center text-center  text-lg-start ">
                            ...
                            <nav className="nav justify-content-center justify-content-lg-start ">
                                <a href='#' className="nav-link"><img src="/images/payment/paypal.svg" alt="Paypal" /> </a>
                                <a href='#' className="nav-link"><img src="/images/payment/mastercard.svg" alt="Mastercard" /> </a>
                                <a href='#' className="nav-link"><img src="/images/payment/visa.svg" alt="Visa" /> </a>
                            </nav>
                        </div>
                    </div>
                </div>
